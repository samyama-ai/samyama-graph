...
CASES = [
    ...
    # The weekly run stopped two weeks ago. Nothing is red; nothing has looked.
    ("a stale pass blocks", 1,
     {"status": "pass", "measured_at": stamp(14), "host": "vm-1"}),
    ...
    # Weekly cadence (owner, 2026-09-17), plus a day for a delayed run.
    ("eight days is inside the window", 0,
     {"status": "pass", "measured_at": stamp(8), "host": "vm-1"}),
    ("nine days is not", 1,
